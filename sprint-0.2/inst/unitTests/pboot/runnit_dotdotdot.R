...
# set.seed(27)
# a = boot(discoveries, ddd, R=100, mydd = trees$Girth)
# set.seed(27)
# b = pboot(discoveries, ddd, R=100, mydd = trees$Girth)
# checkEquals(a,b,"label passed via ...")
 
# set.seed(27)
# a = boot(discoveries, ddd, R=100, mydd = sample(5))
# set.seed(27)
# b = pboot(discoveries, ddd, R=100, mydd = sample(5))
